...
APP_STATE = {"version": "v1", "cpu_load": 0, "is_corrupted": False}
...
def read_root():
    ...
    return {"version": "v1", "message": "Servis v1 Aktif", "load": f"%{APP_STATE['cpu_load']}"}
